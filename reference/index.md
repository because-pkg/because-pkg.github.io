...
- [`because_continue()`](https://because-pkg.github.io/because/reference/because_continue.md)
...
- [`do()`](https://because-pkg.github.io/because/reference/do.md)
  [`because_do()`](https://because-pkg.github.io/because/reference/do.md)
  : Causal Interventions for Structural Equation Models
- [`do(`*`<because>`*`)`](https://because-pkg.github.io/because/reference/do.because.md)
...
- [`get_latent_predictor_name()`](https://because-pkg.github.io/because/reference/get_latent_predictor_name.md)
...
- [`is_auxiliary_equation()`](https://because-pkg.github.io/because/reference/is_auxiliary_equation.md)
...
- [`plot_rope()`](https://because-pkg.github.io/because/reference/plot_rope.md)
  : Plot Region of Practical Equivalence (ROPE)
- [`plot_rope(`*`<because>`*`)`](https://because-pkg.github.io/because/reference/plot_rope.because.md)
...
- [`summary(`*`<because_counterfactual>`*`)`](https://because-pkg.github.io/because/reference/summary.because_counterfactual.md)
