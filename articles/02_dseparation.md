...
```
    ...
    Test: Humans _||_ Area | {Birth} 
            Parameter Estimate LowerCI UpperCI  Rhat
     beta_Humans_Area    0.191  -0.648    1.06 1.004
     n.eff
      2055
    ...
    Test: Birth _||_ Storks | {Area} 
             Parameter Estimate LowerCI UpperCI Rhat
     beta_Birth_Storks    0.125  -0.199   0.459    1
     n.eff
      3082


    Test: Humans _||_ Storks | {Area,Birth} 
              Parameter Estimate LowerCI UpperCI  Rhat
     beta_Humans_Storks   -0.282  -0.711    0.13 1.002
     n.eff
      3000
...
Shipley, B. (2009). Testing recursive path models with correlated errors
using d-separation. **Structural Equation Modeling**, 10(2), 214-221.
<https://doi.org/10.1207/S15328007SEM1002_3>
