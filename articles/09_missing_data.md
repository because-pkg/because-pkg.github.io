...
This approach has two important advantages over common alternatives such
as list-wise deletion or multiple imputation (MICE):
...
for the path coefficients because it uses more information, and it
avoids any bias from non-random missingness patterns.
