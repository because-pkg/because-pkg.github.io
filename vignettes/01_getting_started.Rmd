...
-   [Non-Gaussian Distribution Families](08_non_gaussian_families.html):
...
-   [Bayesian Missing Data Imputation](09_missing_data.html):
     ...
     within the SEM.
-   [Model Diagnostics and Comparison](10_model_diagnostics_comparison.html):
...
-   *Advanced Model Specifications:* [random effects](07_multilevel_models.html)
    (lme4-style `(1|group)` notation, mixed models, nested designs),
    polynomial terms, categorical predictors, measurement error.
-   *[Multilevel & Hierarchical Data](07_multilevel_models.html):* Multi-level data with variables at
    different hierarchical levels and correct degrees of freedom in d-separation tests.
