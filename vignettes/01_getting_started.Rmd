...
-   *Advanced Model Specifications:* [random effects](08_multilevel_models.html)
    (lme4-style `(1|group)` notation, mixed models, nested designs),
    polynomial terms, categorical predictors, measurement error.
-   *[Multilevel & Hierarchical Data](08_multilevel_models.html):* Multi-level data with variables at
