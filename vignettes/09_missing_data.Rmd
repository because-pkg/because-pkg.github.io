...
This approach has two important advantages over common alternatives
such as list-wise deletion or multiple imputation (MICE):
...
posterior. See the [Deterministic Nodes vignette](05_deterministic_nodes.html)
for details.
...
example from the [Deterministic Nodes vignette](05_deterministic_nodes.html):
...
for the path coefficients because it uses more information, and it avoids
any bias from non-random missingness patterns.
...
| Deterministic relationships among variables | Use [Deterministic Nodes](05_deterministic_nodes.html); constraints are preserved during imputation. |
