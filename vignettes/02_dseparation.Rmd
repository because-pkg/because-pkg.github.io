...
vignette: >
  %\VignetteIndexEntry{D-Separation and Causal Inference}
...
We can now use the function `plot_dag` to plot the DAG of the fitted model with the estimated path coefficients:
```{r}
...
Shipley, B. (2009). Testing recursive path models with correlated errors using d-separation. **Structural Equation Modeling**, 10(2), 214-221. https://doi.org/10.1207/S15328007SEM1002_3
